module.exports = function (dataService) {
    ...
    return {
        ...
        addNews: function (req, res, next) {
            if(Object.keys(req.body).length == 3 && req.body.title && req.body.title.length < 255 && req.body.shortDescription && req.body.shortDescription.length < 1023 && req.body.body) {
